...
namespace libmpdataxx
{
  namespace solvers
  {
    ...
    class mpdata_fct<real_t, n_iters, 2, n_eqs, halo> : public detail::mpdata_fct_common<real_t, n_iters, 2, n_eqs, halo> 
    {
      using parent_t = detail::mpdata_fct_common<real_t, n_iters, 2, n_eqs, halo>; 
