...
namespace libmpdataxx
{
  namespace solvers
  {
    namespace detail
    {
      template<typename real_t, int n_eqs, int n_tlev, formulae::opts::opts_t opts, int minhalo>
      class solver<real_t, 1, n_eqs, n_tlev, opts, minhalo> : public solver_common<real_t, 1, n_eqs, n_tlev, minhalo>
      {
