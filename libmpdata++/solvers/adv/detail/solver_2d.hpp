...
namespace libmpdataxx
{
  namespace solvers
  {
    namespace detail
    {
      ...
      class solver<real_t, 2, n_tlev, n_eqs, opts, minhalo> : public solver_common<real_t, 2, n_tlev, n_eqs, minhalo>
      {
	using parent_t = solver_common<real_t, 2, n_tlev, n_eqs, minhalo>;
