...
namespace libmpdataxx
{
  namespace solvers
  {
    ...
    class mpdata_fct<real_t, 2, opts, minhalo> : 
      public detail::mpdata_fct_common<real_t, 2, opts, minhalo> 
    {
...
// TODO: other option would be to define im as a function of halo in mpdata!
	...
	this->GC_mono[0]( im+h, jm ) = formulae::mpdata::GC_mono<opts, 0>(psi, this->psi_min, this->psi_max, GC_corr, G, im, jm);
	this->GC_mono[1]( im, jm+h ) = formulae::mpdata::GC_mono<opts, 1>(psi, this->psi_min, this->psi_max, GC_corr, G, jm, im);
