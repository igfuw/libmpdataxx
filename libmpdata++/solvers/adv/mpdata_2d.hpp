...
namespace libmpdataxx
{
  namespace solvers
  {
    ...
    class mpdata<real_t, 2, n_eqs, opts, minhalo> : 
      public detail::mpdata_common<real_t, 2, n_eqs, opts, minhalo>
    {
      using parent_t = detail::mpdata_common<real_t, 2, n_eqs, opts, minhalo>;
