...
namespace libmpdataxx
{
  namespace solvers
  {
    ...
    template<typename real_t, int n_iters, int n_eqs, formulae::mpdata::opts_t opts, int halo_>
    class mpdata<real_t, n_iters, 2, n_eqs, opts, halo_> : 
      public detail::mpdata_common<real_t, n_iters, 2, n_eqs, opts, halo_>
    {
      using parent_t = detail::mpdata_common<real_t, n_iters, 2, n_eqs, opts, halo_>;
