...
namespace libmpdataxx
{
  namespace solvers
  {
    namespace detail
    {
      ...
      class mpdata_rhs_vip_prs_3d_gcrk : public detail::mpdata_rhs_vip_prs_3d_common<ct_params_t>
      {
        public:
	...
	arrvec_t<typename parent_t::arr_t> p_err, lap_p_err;
	  ...
	  lap_p_err[0](this->ijk) = this->lap(p_err[0], this->i, this->j, this->k, this->di, this->dj, this->dk);
        }
        ...
        void pressure_solver_loop_body()
        {
          for (int v = 0; v < k_iters; ++v)
          {
            ...
            lap_err(this->ijk) = this->lap(this->err, this->i, this->j, this->k, this->di, this->dj, this->dk);
	...
	static void alloc(
	  ...
	  parent_t::alloc_tmp_sclr(mem, grid_size, __FILE__, 1);
	  parent_t::alloc_tmp_sclr(mem, grid_size, __FILE__, k_iters);
	  parent_t::alloc_tmp_sclr(mem, grid_size, __FILE__, k_iters);
	}
      }; 
    }; // namespace detail
