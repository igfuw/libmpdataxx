      ...
      > : public detail::mpdata_rhs_vip_prs_sgs_fra_common<ct_params_t, minhalo>
      {
        ...
        void interpolate_refinee(const int e = 0)
        {
          ...
          for(int i=0; i<this->n_fra_iter; ++i)
          {
            ...
            formulae::fractal::intrp<0, real_t>(this->mem->psi_ref[e], mid_ijk_r2r_0, ijk_r2r_1_h, ijk_r2r_2_h, hstride);
            this->mem->barrier();
            formulae::fractal::intrp<1, real_t>(this->mem->psi_ref[e], mid_ijk_r2r_1, ijk_r2r_2_h, ijk_r2r_0_h_with_halo, hstride);
            formulae::fractal::intrp<2, real_t>(this->mem->psi_ref[e], mid_ijk_r2r_2, ijk_r2r_0_h_with_halo, this->rng_merge(ijk_r2r_1_h, mid_ijk_r2r_1), hstride);
          }
          this->mem->barrier();
        }
        ...
        void reconstruct_refinee(const int e = 0)
        {
          ...
          for(int i=0; i<this->n_fra_iter; ++i)
          {
            ...
            formulae::fractal::rcnstrct<0, real_t>(this->mem->psi_ref[e], this->rng_dbl_stride(mid_ijk_r2r_0, offset), ijk_r2r_1_h,           ijk_r2r_2_h,                                 hstride, this->c_j, this->d_j, this->f_j);
            this->mem->barrier();
            formulae::fractal::rcnstrct<1, real_t>(this->mem->psi_ref[e], this->rng_dbl_stride(mid_ijk_r2r_1)        , ijk_r2r_2_h,           ijk_r2r_0_h_with_halo,                       hstride, this->c_j, this->d_j, this->f_j);
            formulae::fractal::rcnstrct<2, real_t>(this->mem->psi_ref[e], this->rng_dbl_stride(mid_ijk_r2r_2)        , ijk_r2r_0_h_with_halo, this->rng_merge(ijk_r2r_1_h, mid_ijk_r2r_1), hstride, this->c_j, this->d_j, this->f_j);
          }
          this->mem->barrier();
        }
