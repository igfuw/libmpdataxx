      ...
      > : public solver_common<ct_params_t, n_tlev, minhalo>
      {
        ...
        ) final
        {
          ...
          for (int e = 0; e < parent_t::n_eqns; ++e) // equations
          {
            ...
            {
              for (auto &bc : this->bcs[0]) bc->save_edge_val(this->mem->psi[e][n], this->mem->psi[e][0], range_ijk[1], range_ijk[2]);
              barrier_if_single_threaded_bc0();
              for (auto &bc : this->bcs[1]) bc->save_edge_val(this->mem->psi[e][n], this->mem->psi[e][0], range_ijk[2], range_ijk[0]);
              for (auto &bc : this->bcs[2]) bc->save_edge_val(this->mem->psi[e][n], this->mem->psi[e][0], range_ijk[0], range_ijk[1]);
              this->mem->barrier();
            }
          }              
        }
